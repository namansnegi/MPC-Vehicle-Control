...
Timesteps and Frequency were chosen by trial and error. Adjusting either N or dt (even by small amounts) often produced erratic behavior.The values chosen for N and dt are 10 and 0.1, respectively. These values mean that the optimizer is considering a one-second duration in which to determine a corrective trajectory.  Other values tried include 20 / 0.05, 8 / 0.125, 6 / 0.15, and many others. 
...
A third degree polynomial is used to calculate the trajectory of the car.
